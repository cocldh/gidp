            ...
            <table className="w-full text-sm border-collapse">
                ...
                <tr>
                  {["Changed At", "Tag Number", "Column", "Old Value", "New Value", "Change Reason", "Commit Description", "Changed By"].map(
                    (h) => (
                      <th
                        key={h}
                        className="text-left px-4 py-2.5 font-semibold text-gray-600 dark:text-slate-300 border-b border-gray-200 dark:border-slate-600 whitespace-nowrap"
                      >
                        {h}
                      </th>
                    ),
              ...
              <tbody>
                {logs.map((log) => (
                  ...
                  >
                    <td className="px-4 py-2 whitespace-nowrap text-gray-500 dark:text-slate-400 text-xs">
                      {formatDate(log.changed_at)}
                    </td>
                    <td className="px-4 py-2 text-gray-700 dark:text-slate-300 font-mono text-xs whitespace-nowrap">
                      {log.tag_number ?? <span className="text-gray-300 dark:text-slate-600">—</span>}
                    </td>
                    <td className="px-4 py-2 max-w-[160px]">
                      <span
                        className="block truncate font-mono text-xs text-blue-600 dark:text-blue-400"
                    ...
                    <td className="px-4 py-2 max-w-[180px]">
                      <span
                        className="block truncate text-red-500 dark:text-red-400 text-xs"
                        title={log.old_value ?? ""}
                      >
                    ...
                    <td className="px-4 py-2 max-w-[180px]">
                      <span
                        className="block truncate text-emerald-600 dark:text-emerald-400 text-xs"
                        title={log.new_value ?? ""}
                      >
